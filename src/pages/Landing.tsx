        ...
        <div className="container mx-auto px-4 py-16 relative">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16 mb-32 pt-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent leading-tight">
                Visualize Your
                <br />
                GitHub Universe
              </h1>
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <Button
                  onClick={() => navigate("/auth")}
                  className="group px-6 py-6 text-lg bg-white hover:bg-white/90 text-black"
                >
                  Get Started Free
            ...
            <div className="flex-1">
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                <div className="absolute -inset-4">
                  <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/30 via-blue-500/30 to-emerald-500/30 blur-3xl opacity-60 animate-pulse" />
                  <div className="absolute inset-0 bg-gradient-to-bl from-blue-600/20 via-indigo-500/20 to-purple-500/20 blur-2xl" />
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 via-blue-500/20 to-purple-500/20 blur-xl opacity-80" />
                </div>
